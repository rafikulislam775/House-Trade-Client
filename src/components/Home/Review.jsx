...
const Review = () => {
  ...
  return (
    <div>
      <div className="space-y-2 text-center mt-10 bg-gray-200 my-10 p-10">
      ...
      <Marquee>
        {data?.map((item) => (
          <div
            key={item._id}
            className="container grid grid-rows-1 w-full max-w-lg p-6 mx-auto mb-4 divide-y rounded-md dark:divide-gray-700 dark:bg-gray-900 dark:text-gray-100"
          >
            <div className="flex justify-between p-4">
              ...
              <div className="flex items-center space-x-2 animate-bounce dark:text-yellow-500">
                <svg
